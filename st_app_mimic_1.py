...
st.write('Python is a versatile language that you can use for web development, data analysis, artificial intelligence, '
         'and more. Its simplicity allows you to focus on solving problems, rather than on syntax.')
st.caption('Python powers some of the world\'s most complex applications.')
st.code("print('Hello, World!')", 'python', True)
